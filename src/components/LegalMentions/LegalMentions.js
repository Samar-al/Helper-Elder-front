    ...
    <div className="legalmentions">
      ...
      <div className="legalmentions_text">
        ...
        <p>
          ...
          et une mise à jour fiable de ses sites internet.
          Toutefois, des erreurs ou omissions peuvent survenir. L’internaute devra donc s’assurer de l’exactitude des informations auprès de HelpersElders,
          et signaler toutes modifications du site qu’il jugerait utile. HelpersElders n’est en aucun cas responsable de
        ...
        <p>
          ...
          SARL HelpersElders ne dispose d’aucun moyen pour contrôler les sites en connexion avec ses sites internet.
          HelpersElders ne répond pas de la disponibilité de tels sites et sources externes, ni ne la garantit.
          ...
          Les utilisateurs, les abonnés et les visiteurs des sites internet  ne peuvent pas mettre en place un hyperlien en direction de ce site
          sans l’autorisation expresse et préalable de SARL HERLPERSELDERS.
          Dans l’hypothèse où un utilisateur ou visiteur souhaiterait mettre en place un hyperlien en direction d’un des sites internet de SARL HERLPERSELDERS,
          ...
          La SARL HERLPERSELDERS se réserve le droit d’accepter ou de refuser un hyperlien sans avoir à en justifier sa décision.
        </p>
        ...
        <p>
          ...
          Si vous constatez une lacune, erreur ou ce qui parait être un dysfonctionnement, merci de bien vouloir le signaler par courriel,
          à l’adresse herlpers.elders@gmail.com, en décrivant le problème de la manière la plus précise possible (page posant problème, type d’ordinateur et de navigateur utilisé, …).
          ...
          De plus, l’utilisateur du site s’engage à accéder au site en utilisant un matériel récent, ne contenant
          ...
          présentes sur le réseau Internet ne sauraient engager la responsabilité de SARL HERLPERSELDERS.
        </p>
        ...
        <p>
          ...
          de ces différents éléments est strictement interdite sans l’accord exprès par écrit de SARL HERLPERSELDERS.
          Cette représentation ou reproduction, par quelque procédé que ce soit, constitue une contrefaçon sanctionnée
          par les articles L.335-2 et suivants du Code de la propriété intellectuelle. Le non-respect de cette interdiction
        ...
        <p>
          ...
          des personnes physiques à l’égard des traitements de données à caractère personnel) relative à l’informatique,
          aux fichiers et aux libertés, ce site a fait l’objet d’une déclaration 1656629 auprès de la Commission nationale de l’informatique et des libertés (www.cnil.fr).
        </p>
        <h1>Litiges :</h1>
        <p>
        ...
        <h1>Crédits :</h1>
        <p>Mentions pour la page <span>Accueil</span> :</p>
        <p>
          Photo de <a href="https://unsplash.com/@dani_franco?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText"> Danie Franco </a>
          sur <a href="https://unsplash.com/fr/photos/l9I93gZKTG4?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText"> Unsplash</a>,
          photo de <a href="https://unsplash.com/@elgassier?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText"> M.T ElGassier </a>
          sur <a href="https://unsplash.com/fr/photos/aCZ2hiC-iDk?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText"> Unsplash</a>,
          photo de <a href="https://unsplash.com/@mikitayo?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText"> Mikita Yo </a>
          sur <a href="https://unsplash.com/fr/photos/udDTgKBRUq8?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText"> Unsplash</a>.
        </p>
        <p>
          Icônes sur FlatIcon : <a href="https://www.flaticon.com/fr/icones-gratuites/les-courses" title="les courses icônes"> Courses</a>,
          <a href="https://www.flaticon.com/fr/icones-gratuites/douche" title="douche icônes"> Toilette</a>,
          <a href="https://www.flaticon.com/fr/icones-gratuites/taxi" title="taxi icônes"> Chauffeur</a>,
          <a href="https://www.flaticon.com/fr/icones-gratuites/nettoyage" title="nettoyage icônes"> Ménage</a>,
          <a href="https://www.flaticon.com/fr/icones-gratuites/amour-et-romance" title="amour et romance icônes"> Compagnie</a>,
          <a href="https://www.flaticon.com/fr/icones-gratuites/cuisine" title="cuisine icônes"> Cuisine</a>,
          <a href="https://www.flaticon.com/fr/icones-gratuites/geriatrie" title="gériatrie icônes"> Soins médicaux</a>,
          <a href="https://www.flaticon.com/fr/icones-gratuites/amour-et-romance" title="amour et romance icônes"> Logo </a> par défaut pour les services,
          <a href="https://www.flaticon.com/fr/icones-gratuites/engagement" title="engagement icônes"> Logo </a>par défaut pour un utilisateur.
        </p>
        <p>
          Mentions pour la page <span>À propos</span> :
          Photo de <a href="https://unsplash.com/@mbennettphoto?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText"> Matt Bennett </a>
          sur <a href="https://unsplash.com/fr/photos/78hTqvjYMS4?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText"> Unsplash</a>
        </p>
      </div>
    </div>
  );
